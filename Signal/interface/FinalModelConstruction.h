...
class FinalModelConstruction {
 ...
 public:
  ...
  RooGenericPdf* buildtheBDTPdf(std::string name, std::map<string,RooSpline1D*> splines, string thebdt);
  ...
  RooAbsReal *getVariableWithPhotonSyst(RooAbsReal *var_fit, string name, string varname);
    
  void setRVsplines(std::map<std::string,RooSpline1D*> splines);
  void setWVsplines(std::map<std::string,RooSpline1D*> splines);
  void setBDTsplines(std::map<std::string,RooSpline1D*> splines);
  ...
  void setBDTdatasets(std::map<int,RooDataSet*> data);
 ...
 private:
  ...
  std::map<std::string,RooSpline1D*> BDTSplines;
  std::map<int,RooDataSet*> rvDatasets;
  std::map<int,RooDataSet*> wvDatasets;
  std::map<int,RooDataSet*> BDTDatasets;
  ...
  std::map<std::string,std::map<int,std::map<std::string,double> > > varSysts;
