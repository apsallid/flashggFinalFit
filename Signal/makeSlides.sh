...
echo "cat  $pwd0/$EXT/sigfit/slides/Intro.tex $pwd0/$EXT/sigfit/slides/slide*{GG2H,VBF,TTH,QQ2HLL,QQ2HLNU,WH2HQQ,ZH2HQQ}*tex  $pwd0/$EXT/sigfit/slides/Outro.tex > $pwd0/$EXT/sigfit/slides/fullslides.tex"
cat  $pwd0/$EXT/sigfit/slides/Intro.tex $pwd0/$EXT/sigfit/slides/slide*{GG2H,VBF,TTH,QQ2HLL,QQ2HLNU,WH2HQQ,ZH2HQQ}*tex  $pwd0/$EXT/sigfit/slides/Outro.tex > $pwd0/$EXT/sigfit/slides/fullslides.tex
